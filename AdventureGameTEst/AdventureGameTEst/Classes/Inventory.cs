...
namespace AdventureGameTEst.Classes
{
    class Inventory : Base
    {
        ...
        public Inventory(int itemId, string itemName, string itemDescription, bool key)
        {
            Id = itemId;
            Name = itemName;
        ...
        public static List<Inventory> InventoryList()
        {
            ...
            Inventory bucket = new Inventory(0, "Bucket", "You found a bucket.It reeks but maybe there's a use for it?", false);
            Inventory painting = new Inventory(1, "Painting", "A painting of my great idol, Adobe Gitler", false);
        }
